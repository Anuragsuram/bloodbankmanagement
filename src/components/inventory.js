...
const Inventory = () => {
  ...
  const handleSumbit = (e) => {
    ...
    e.preventDefault();
    axios
    .post('/createinventory', {bgname:groupname,quantity:quantity}, {
      headers: {
        "Content-Type": "application/json",
      },
    })
    .then((response) => {alert("Invetory added successfully");navigate('/inventorylist');});
  };
  return (
    <div id="home">
      <center>
        ...
        >
          <div className="form-group">
            ...
            <select id="bloodgroup" value={groupname} className="form-control" required onChange={(event) => handleChange(event)}>
